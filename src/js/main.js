...
;(function(){
    ...
    const API_URL_BASE= 'https://www.flickr.com/services/rest/?method=flickr.photos.getPopular&api_key=47fa016833c10c7cf777062f48eb2908&user_id=184085204%40N06&format=json&nojsoncallback=1';
    ...
    function makeSearchRequest(event){ //changes value/calls getUserData()
        ...
        const photoSearch = picSearch_query.value
        console.log('value of photo query: ', photoSearch)
       //getQueryData(photoSearch)
    }
